...
# III RTOS Implementation on RV32I Core
...
## 7. Acknowledgments
This project was accomplished as part of my **Research Internship at IIT Tirupati** under the guidance of **Prof. Vikram Kumar Pudi**. Special thanks to:
- **RISC-V Community** for open-source resources and support.
- **FreeRTOS** for real-time OS implementation references.
- **Rocket Core and SiFive** for architecture insights.
- **Steel Documentation** for RTOS integration guidance.
